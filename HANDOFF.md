...
**Latest commit (v2.1-UX UI workstream):** `020e48c fix(a11y): keyboard-operable project tree + touch-reachable row actions (Phase 5)` (+ chat-card fix `835518a` and its runtime-verification schema fix `ee5c5bf`)
