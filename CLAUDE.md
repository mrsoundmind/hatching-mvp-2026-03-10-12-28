...
*Last updated: 2026-09-01 (IN-CHAT DOCUMENT EDITING shipped on-branch: attach a file in chat, tell an agent to edit it, get it back as a download in the SAME format [all six: Word/PDF/Markdown/text/Excel/CSV]; the ONLY new UI is a download card in the agent reply, proven live end-to-end, see the 2026-08-26 to 08-28 entry near the END of this footer; earlier learning-loop MEASURED: Hatchin's self-improving loop is built + wired but does NOT make agents smarter turn-to-turn [growth-loop lessons ~0/in-noise, the strong AKL mechanism DORMANT because web research is gated off]; an outcome-based growing-playbook PLAN is written [`.planning/growth-loop-outcome-based-PLAN.md`], sequenced scoreboard-first [measure if agents help users] then learning-layer-deferred; the role-selective multi-pass was PROVEN live on the real endpoint [+1.06 best-case on short chat Qs, +0.17 realistic 34-role avg] and covers ALL non-precision roles + any NEW agent automatically by category; a full backup was tagged + pushed to the backup remote — see the 2026-08-24 to 08-26 entry at the END of this footer; earlier v2.3 agent-intelligence investigation: a proper 6-dimension competency benchmark proved the top-1% ceiling is REASONING-side and model-bound [frontier gpt-5 lifts reasoning +0.48, creativity 2.73 to 3.40], but the shipped fix is a DeepSeek-only role-selective rigor-gated cheap multi-pass [gated OFF by default], NOT paying for GPT, see the v2.3 entry at the END of this footer; earlier RAG deepening campaign COMPLETE, all 34 role knowledge bases now even + mastery-complete at 130 to 209 chunks, corpus 4429 to 7852, see the 2026-08-15 entry at the END of this footer; earlier Business-in-a-Box Batch 2 packs, Web3/AgTech/Logistics/Telehealth, authored + registered + tsc-clean + seed-verified + live-picker-verified, see the 2026-08-14 entry near the END of this footer; earlier approval-card redesign + daily-limit one-notice bug-fix shipped on-branch and live-proven, see the 2026-08-13 entry near the END of this footer; earlier Business-in-a-Box packs milestone kicked off + BIAB-0 increment 1 pack-blueprint system shipped server-side and live-proven, see the 2026-08-10 entry near the END of this footer; earlier 2026-08-06/07 chat-attachments engine + composer UI; 2026-08-03 Per-role RAG deep knowledge + cross-role matrix + Juhi role + OpenAI production embedder shipped and live-proven, see the 2026-08-03 entry near the end of this footer; earlier 2026-08-01 Pre-Launch Hardening pass: all code-doable Tier-0 launch blockers closed, 3 items remain needing user/staging/npm; v2.1-UX Phase 5 Left Sidebar folder redesign + collapsible focus rail shipped; v2.2 Phase 39 Reader Testing Plans 39-01 server + 39-02 UI shipped; v2.1-UX Phases 0-2 shipped parallel) | Branch: feat/v2.2-intelligence-fixes (audit remediation, off wip/pre-reset-2026-04-28) | v2.1 in progress: Phase 35/36/36.5/37 shipped + Phase 38 Plans 01/02/03/04 all shipped 2026-06-21 through 2026-07-10 (Plan 38-05 human vibe-check + 38-VERIFICATION.md remaining before phase closes). ALWY-01/03/04/05/06 all ✅ SHIPPED, ALWY-02 ⚠ PARTIAL (final closure via 38-05). Progress 23/24 plans (96%). | Phase A DeepSeek migration shipped 2026-05-04 | Supabase migration shipped 2026-06-02 | Phase 35+36 Playwright 12/12 PASS on Supabase | Section 23 (Auto-Routing, approval-first) added 2026-06-04, every skill requires popup approval before firing, see AUTO-ROUTING.md | 2026-06-09: marketing role tactical depth (Wren/Kai/Robin) enriched from coreyhaines31/marketingskills (MIT), committed 2026-07-10 as 5b9e674; injection note: old PROFESSIONAL DEPTH+DOMAIN INTELLIGENCE pair merged into single ROLE EXPERTISE section | 2026-07-06: HANDOFF.md added at repo root, read that first for session-continuity | 2026-07-10 session: shipped Plan 38-02 (safety scorer destructive-intent, ALWY-04, commits 673c158+a4e8942), Plan 38-03 (Maya voice snap at level-4, ALWY-05, commit 748ae66, also fixed buildProviderOrder capture branch residual from Plan 38-01), Plan 38-04 (universal AGENT_CAPABILITY_ENVELOPE, ALWY-06, commit a017055). Marketing enrichment eval A/B validated 7/9 → 9/9 markers (+22pp) with Robin schema-confabulation prevention landing textbook. Fly.io cost model: min=0 pre-public ~$0-3/mo ₹0-258, min=1 post-launch ~$6.48/mo ₹557. Ambient constellation rule broadened 2026-07-10: CLAUDE.md AND HANDOFF.md AND STATE.md AND REQUIREMENTS.md AND ROADMAP.md updated atomically per change. | 2026-07-18 Audit Remediation (2026-07-17 live audit): v2.1 feature work paused; 10 commits on fix/audit-remediation-2026-07-17 fixed the core-value blocks in strict dependency order (pg-boss createQueue #95 revives ALL background autonomy; multi-agent empty-save #74; project-scope @mention #97; brain grounding + auto-fill #79/#105; activity metadata/default-filter/phantom-leak #102/#110/#80/#165; polish #43/#153/#149/#130/#114/#96/#160/#65/#136). Each runtime-verified (real browser for UI via tests/e2e/public-audit-ui.spec.ts, live server for backend). Deferred to Phase 47: #37/#60/#87/#88/#126/#161/#94/#139/#112. Phase 47 backlog #9 resolved. Note #104/#105 were deferred to Phase 42, NOT fixed, despite commit b7e5292's message claiming them. | 2026-07-20 Wave 6 (remediation reopened): right-sidebar pass found 3 never-tracked audit findings (#83 stats counters counted event names nothing emits; #108 Tree empty because no code path ever finalized a run, fixed by new completeRun() in runTreeWriter.ts; #109 category map duplicated server/client and drifted, collapsed into shared/activityLabels.ts) plus a bug absent from the audit: useAutonomyFeed.ts hardcoded the Activity time window to 'today' with no setter, emptying every project's panel at midnight. Commits cdbdd9b, ccfa905, f2b6885, all browser-verified. Close-out: 1a3b979 (deleted orphaned ApprovalsEmptyState), dadb686 (Work Outputs recorded neither executing agent nor produced output, so it showed "Hatch" over the task description; new markTaskCompleted helper covers all 3 completion paths, 6 of 8 historical rows recovered by joining messages on metadata.taskId), c549f9c (handoff chain PROVEN end to end via seeded dependsOn pair, live worker executed it, receiving agent produced 688 chars from the upstream scope; exposed 2 label bugs: the label read flat toAgentName while handoff_initiated nests toAgent.name so every real handoff rendered anonymously, and self-handoffs claimed a handoff that never happened). All Wave 6 re-verified live on restarted server (Alex→Rex handoff, browser labels correct). Decisions: 2026-07-20 UX audit → new v2.1-UX milestone (starts after Phase 38); Rex-vs-Remy chat/feed name mismatch → Phase 47 backlog #18. | 2026-07-21 Phase 38 CLOSED via Plan 38-05 vibe-check on DeepSeek (user-delegated); caught + fixed pre-existing safety-message truncation (e61be9b: safety interventions bypass the tone guard, whose adaptLength was cutting the 3 clarification questions to "...clarify these points:\n1." on short destructive commands; regression test-safety-intervention-integrity.ts 10/10). ALWY-01..06 all ✅. | 2026-07-21 Wave 7: user's independent 3-persona re-audit (.audit-reaudit-2026-07-20/) confirmed 14/15 remediation fixes live and found the intermittent-autonomy bug: pg-boss's fetch loop hangs forever on a half-open Supabase socket (no query_timeout) and wedges, so jobs enqueue but stay 'created' on a long-running instance until restart. Fixed 57f2c94: hardened pg-boss pool (query_timeout + keepAlive) + stall watchdog. Verified live (drained the real 20h-stuck job + fresh run 27s). Known-partial remaining per re-audit triage: #104 KB list (Phase 42). | 2026-07-21 Wave 8: focused Activity-feed audit fixed with verify-then-fix discipline: approval cards leaked raw safety codes (finishing #43 on the 2 surfaces the original missed, shared humanizeRiskReasons in shared/riskReasons.ts, b51f81b); feed visual coherence via /ui-genius (every row gets a face, small for the quiet review tier, "?" bubble → neutral system mark, 571145b); approval events now durable (approval_required/granted/rejected logged at gate + endpoints so the Approvals filter populates, aeba012); handoff respects explicit assignee (Coda→Coda self-handoff → assignee wins, aeba012). All verified live. Note #44 capability wording was closed as part of the humanizer/approval work. Next: merge + fly deploy (all audit blockers fixed) or Phase 39. Full record: .audit-2026-07-17/REMEDIATION-LOG.md. | 2026-07-23 competitive/landscape scan (no code): user asked how Hatchin compares to Slack Workflow Automation + the Claude "C-suite agent" skill packs (alirezarezvani/claude-skills + claude-cto-team, MIT). Verdict recorded — Slack automates the known (trigger→steps+connectors), Hatchin handles the unknown (ambiguous goal→reasoning+deliverable+handoff), so don't position Hatchin as "workflow automation"; the packs are commoditized advisory prompt-personas with no orchestration/peer-review/trust/autonomy/memory runtime, and our roleIntelligence is comparably deep, so the runtime is the moat. Logged the one useful borrow (quantified role formulas + structured peer-review verdict template + confidence tags, all MIT-reusable) as Phase 47 backlog #19; NOT built now per no-mid-milestone-decimal-hotfixes (v2.1 paused on the audit-remediation branch, this is polish). Constellation touched: ROADMAP #19, STATE count 18→19, this footer, HANDOFF log; REQUIREMENTS + COMPLETE-GUIDE intentionally not touched (a pre-triage backlog item creates no requirement and ships no feature). | 2026-07-25: scaffolded a future milestone stub "Reach & Integrations — Mattermost Bridge" (chat-platform bridge, Mattermost first, channel-agnostic seam for Slack/Teams later). Decisions: don't be a comms platform, reach into the team's existing chat; v1 = approvals + a /hatchin one-shot conversation taste reusing logAutonomyEvent + the approve/reject endpoints + generateIntelligentResponse (NO chat-core refactor); Release 2 = full @mention conversation gated on extracting a WS-agnostic orchestrator from handleStreamingColleagueResponse (~1,878 lines, also pays down Phase 47 #3/#4). Grounded in a Mattermost + Slack seamless-integration research pass (outbound bot WebSocket like Socket Mode, ack-fast-work-async, thread everything, no fake streaming, Mattermost Apps Framework deprecated). Restore tag pre-mattermost-integration on 2fec8d4; isolated branch feat/mattermost-bridge; full brief .planning/milestones/mattermost-bridge-BRIEF.md. NOT started; v2.1 still active (paused on audit remediation). | 2026-07-26: v2.2 "Hatches That Remember & Grow" (new branch feat/v2.2-intelligence-fixes, off the audit-verified code) fixes the four agent-intelligence gaps from the 2026-07-25 audit. Phases A (memory: outcome-aware extraction, retire crude keyword extractor), B (first-person voice), C (feedback anchored to role baseline — stops trait-flatten + sycophancy), E (first-person role-expertise reframe), F (agents address the user by name, remembered cross-project) shipped in prior sessions. **Phase D shipped 2026-07-26 — real peer review with teeth:** peer review was deterministic regex, never read the work; now `server/autonomy/peerReview/llmJudge.ts` is a genuine LLM-as-judge (approve/revise/reject + mustFix + confidence) running on **Groq** deliberately — a different model family than the DeepSeek/Gemini writer (anti self-preference bias) and free — **blind to authorship**, fail-safe to no-block. Opt-in `enableLlmJudge` in `peerReviewRunner.ts` (autonomous path only; chat path at chat.ts:2618 unchanged): confident reject → existing `pending_approval` block path (teeth), revise → REAL bounded regeneration via the author model then re-judge (replaces the cosmetic synthesizer). Visibility: `peer_review_feedback` is now a signal event in shared/activityLabels.ts with verb labels ("approved it"/"asked for changes"/"sent it back") + reason/fixes on expand in ActivityFeedItem.tsx (render half landed via parallel UI commit 745ebd8). Verified in runtime: calibration `scripts/eval-peer-review-judge.ts` 0% false-block / 100% catch; integration `scripts/test-peer-review-integration.ts` 7/7 live (bad→blocked, good→passes); real-browser feed proof. typecheck + 5 regression suites green. Commits 6ec4973 (server) + c2887fa (visibility). Nothing merged; all v2.2 on-branch. Deferred to a later milestone: per-role RAG, outcome-based growth loop (consumes Phase C's deferred content-wiring), ambient watchdog policing. NOTE: a parallel session is committing a UI type-scale refresh onto the same branch (commits 745ebd8/d675d87/4bc2461/f03c00c/9a064d6/90af4db). | 2026-07-26 v2.2 close-out (post independent QA browser audit): cross-verified 4 QA residuals against live code/DB before touching anything; 2 were non-issues. T1 (b99b892) judge over-eager 'revise' on good work → now regenerates only on major/critical severity (minor revises ship; reject unaffected; calibration 0% false-block/100% catch held, integration 7/7). T2 (b99b892) 'confidence null' was a MISREAD — it's on the event confidence column + reaches UI via expandableData, only absent from payload JSON (added for completeness). T3 (9ba5149) 'review folds under task' does NOT happen — normalizeAutonomyEvent gives each review event a unique trace id → own feed row (proven code+DB+browser). T4 (8f3b5d0) voices already distinct (max Jaccard 0.185, blind 100%), so no 30-voice rewrite (would strip correct domain words); instead LOCKED IN: test:voice gate 0.60→0.40 + blind eval broadened 5→10 roles (10/10, competence held), roleRegistry/roleIntelligence prose untouched. Audit report artifact updated. Nothing merged. | 2026-07-27 peer-review COVERAGE fix (f5682ab): a 2nd QA pass found the judge only fired when maxRisk>=peerReviewTrigger (0.35), so most low-risk ordinary work shipped UNREVIEWED (whole history had 8 judge verdicts). New shouldReviewAutonomousOutput() in taskExecutionPipeline.ts broadens the gate at both call sites: reviews fire on mid/high risk OR outward-facing/factual content (regardless of risk) OR any substantive deliverable; only trivial acks skip. peerReviewRunner: enableLlmJudge now force-runs review past the legacy risk-only shouldTriggerPeerReview veto (reason coverage_review). Verified: test-review-coverage 5/5, integration 9/9, LIVE before/after 8→11 verdicts after 3 ordinary tasks; calibration still 0% false-block/100% catch; gate:safety+integrity green; chat path untouched. Config: PEER_REVIEW_MIN_CHARS (default 180). Both former feed-lineage residuals now FIXED eb228ca (2026-07-27): R1 — review + autonomous_task_execution events carry taskId + runTraceId in PAYLOAD so a verdict joins back to its task/run; per-event grouping trace_id stays unique so each review keeps its own feed row (T3 preserved, linkage is a payload pointer not the grouping key). R2 — the "~9h timestamp skew" was an artifact of R1 (verdict compared to an unrelated run because unjoinable); columns are timestamptz/UTC and correct, joined to the right run the pair is 1.3s apart. Verified live scripts/verify-review-lineage-live.ts 6/6 + all regressions green. v2.2 now has ZERO known residuals. | 2026-07-27 v2.1-UX UI milestone (adopted from the 2026-07-20 UX Remediation Brief, `.audit-ux-2026-07-20/`) shipped Phases 0-2 on `feat/v2.2-intelligence-fixes` alongside v2.2, 13 UI commits each Playwright-verified live, path-disjoint from the v2.2/Mattermost server work: **Phase 0** `d675d87` load Inter (index.html never requested it), `4bc2461` 13px type-scale floor (`text-xs`→13, new `text-micro`=11, 196 sub-13px sizes migrated across 36 files), `f03c00c` 44px hit areas via invisible `.hit-target` overlay; **Phase 1** `9a064d6`+`90af4db` completion card (chat "done" moment; producer+reviewer via new `task_execution_completed` payload fields agentRole/taskTitle/peerReviewed/reviewerName/reviewerRole/summary; Keep/Refine/Looks-good; no manual hand-off since handoff is automatic), `a8383a8` delegation entrance ("Let the team work on these" in TasksTab + composer "go ahead" hint, gated Pro+autonomyEnabled, reuses checkForAutonomyTrigger), `67fb230` 2-min waiting-state watchdog; **Phase 2** `9f9490b` sharper landing subhead + legibility (headline kept), `c8fed03` refreshed stale `<title>`/OG meta, `dfeeed9` "They don't just agree with you." pushback-proof section (3 verbatim negativeHandling quotes, additive, bento kept), `73f2d55` pricing in plain voice (dropped SKU/TIER/OPERATIONAL/"Deploy →", prices + orange kept), `32468fe` "While you were away" return-briefing card (reads existing metadata.isReturnBriefing). Color rule held (navy/blue frozen, orange kept, additive amber=work/green=done). Phase 3 intentionally NOT built. Nothing merged. | 2026-07-31 v2.2 Phase 39 (Reader Testing Peer Review) — Plan 39-01 (server) shipped: reader-facing doc types (PRD/blog/email/copy/brief/research/process) now get a context-BLIND fresh-reader review the moment they're written (auto) plus a manual re-run endpoint (`POST /api/deliverables/:id/reader-test`). New `server/ai/readerTestReviewer.ts` mirrors the Phase D judge pattern (cross-model Groq vs the DeepSeek/Gemini writer → no self-preference; free; fail-safe null → never blocks). Deliverables never touched peer review before, so this is a NEW reviewer on the document side, independent of the autonomous-task judge. Quote-anchored plain-language annotations persist on new nullable JSONB `deliverable_versions.reader_test` (db:push applied live); `reviewDeliverableForReaderTest()` in deliverableGenerator.ts orchestrates run+persist; READ-04 revision impact = `resolvedFromPrevious` count + reused frozen-rubric score delta. Doc-type gate `isReaderFacingDocType` in shared/deliverableTypes.ts (10 prose types in, 6 structured out, fails closed). Verified: doctype 19/19, context-blind 18/18, LIVE Groq calibration 100% catch / 0% false-alarm, LIVE Groq+Supabase integration 10/10 (6/7 flagged phrases resolved after a fix), tsc 0 errors, gate:safety/integrity/dto green, peer-review path untouched. READ-01/02 done; READ-03/04 server-side done — annotation + accept/reject UI is Plan 39-02 (UI-approval gate). Scoped commit only (my 6 code files + 4 test scripts + REQUIREMENTS/CLAUDE/HANDOFF/GUIDE); STATE.md + ROADMAP.md + package.json intentionally NOT staged (they carry a sibling session's uncommitted v2.1-UX Phase 4 edits — Phase 39 lines land there when the branch is clean). Nothing merged. | 2026-07-31 v2.1-UX **Phase 4 (Brain Tab Information Architecture) shipped** on `feat/v2.2-intelligence-fixes` (added via GSD as a milestone-relative phase — v2.1-UX uses ROADMAP-prose tracking, not the global `NN-` dir scheme where `04`/`39` are taken; artifacts `.planning/phases/v2.1-ux-04-brain-tab-ia/`). Cross-verified the live Brain-tab audit (`.audit-ux-2026-07-20/BRAIN-TAB-FINDINGS.md`) first: 6/8 findings valid + unfixed, 2 (type/tap) overtaken by Phase 0 so reframed. No functional repair — upload/delete/autonomy-dial/knowledge-adherence all re-verified working live; this was a labeling + ordering + self-documenting pass on `BrainDocsTab.tsx` + `AutonomySettingsPanel.tsx` + `DocumentCard.tsx` (+ `server/routes/projects.ts` title default). 4 atomic Playwright-verified commits: `6177021` P0-A/B (the "Project Knowledge Base" divider rendered the empty `<PackageProgress>` — renamed to Packages + honest "No active packages" empty state, duplicate name gone), `2c6f6a9` P1-A/B (Knowledge Base leads the tab under Core Direction; inner "Autonomy Settings" header removed so one Autonomy header), `5756cce` P1-C (server derives a real doc title from content's first line + client fallback for legacy rows — never "Untitled Document"; server-side live-confirm deferred to next dev-server restart, plain `tsx` no watch, unit 5/5), `29727a4` P1-D/E/P2-A (count/state pills on every header, headers 13px bold bright, level buttons + delete 44px). Constellation: STATE + ROADMAP + this footer + HANDOFF updated (the sibling session reserved STATE/ROADMAP for me); REQUIREMENTS + COMPLETE-GUIDE intentionally not touched (an IA/presentation fix ships no new feature/requirement, per the 2026-07-23 precedent). VERIFICATION.md in the phase dir. Nothing merged. | 2026-07-31 Phase 39 Plan 39-02 (UI) shipped through the UI-approval gate: `ReaderTestBanner.tsx` renders the Fresh Reader Review in the Artifact panel, a self-documenting banner (always-visible "A teammate read this cold…" explainer + plain-English verdict + flagged-spot cards with plain-word severities "Reader gets stuck"/"Reader has to guess", NOT codes), inline amber underlines on flagged phrases via `highlightReaderFlags()` in ArtifactPanel.tsx (string children only, nested markdown untouched), Mark-addressed/Dismiss session-local triage, Re-run button (manual endpoint) + "Resolved N spots" clarity line. Gate followed properly: captured current panel via Playwright, then published an interactive prototype the user clicked through, then 2 rounds of copy sharpening for self-documentation, only THEN edited client/src. Verified LIVE on a self-owned :5005 server (memory mode, real Groq; sibling's :5001 untouched, no process kills): real endpoint returned annotations, real banner rendered amber with 5 real-LLM cards, Mark-addressed faded a card + dropped count 5→4. No server changes in 39-02 (the /versions endpoint already returns the reader_test column). tsc 0 errors. READ-01..04 all ✅. STATE/ROADMAP still deferred (still carry the sibling's uncommitted v2.1-UX Phase 4 edits). Nothing merged. | 2026-08-01 v2.1-UX **Phase 5 (Left Sidebar)** — began as a live audit pass (6/8 findings valid) but evolved with ~8 rounds of live design feedback into a **folder-identity redesign + collapsible focus rail**; user rejected emojis/initials/"scattered colour" so audit's P0-B emoji fix was dropped, and the durable rule `feedback_no_left_accent_rail` was saved (no left border/accent-rail selection cue). Shipped, all Playwright-verified live, `client/src` only (LeftSidebar.tsx + ProjectTree.tsx), path-disjoint from v2.2/Phase 39 server work: row redesign 6f78897/7f43efe/1c88d5a/3dfcf92 (folder identity, name-led with idle names dimmer than chat + active bright, expanded-project-as-container, live team pulse, colour reserved for working state); approval-buttons-never-wrap 8dd519a (→ `feedback_ui_self_documenting` rule #7); P0-A account menu 5dc8965 (Radix DropdownMenu replacing a non-keyboard `<div onClick>`); **collapse-to-focus-rail e01a107** (remembered 60px rail via ⌘\/header Collapse/rail chevron; chat gains the width automatically since it's `flex-1` → ZERO home.tsx/server changes; desktop-only via matchMedia so the mobile drawer stays full; when collapsed the account avatar still opens the menu, search expands-then-focuses, +New opens Quick Start, folders show names on Radix portal tooltips that escape the scrollable rail; colour only means "look here" — active=full colour+highlight, team-working=amber+live count via useAgentWorkingState cross-project, idle=dimmed to 0.4); **auto-collapse-on-team-start 5226136** (user-chosen trigger; active-project idle→working transition folds into the rail, fires once/session, any manual toggle disarms, never persists — transient focus so the remembered preference stays manual-only). Verified live on the running server: collapse/expand all 3 ways + 60↔260, dimming numeric (active opacity 1 / 10 idle folders 0.4), amber badge from a real agent_working_state event, portal tooltip unclipped, account menu from the rail avatar, remembered across reload, auto-collapse fired 260→60 without persisting + did nothing for a non-active project + stayed disarmed after a manual expand. Remaining (accessibility): P0-C keyboard tree, P1-C touch kebab, P1-D 44px "+New". Constellation: STATE + ROADMAP (my own uncommitted Phase 5 lines rewritten for the pivot) + this footer + HANDOFF updated; REQUIREMENTS + COMPLETE-GUIDE intentionally not touched (a presentation/UX pass ships no new feature/requirement — Phase 4 / 2026-07-23 precedent). Nothing merged. | 2026-08-01 (cont.) Phase 5 **finished** + a cross-cutting chat-card bug fixed: (a) matched collapse/expand icon pair `ff1060f` (PanelLeftClose/PanelLeftOpen, 18px); (b) **accessibility done** `020e48c` — project/team/agent rows tabbable + Enter/Space activate (guarded by `e.target===e.currentTarget` so the rename input never double-fires) + focus-visible ring; options/delete buttons reachable on `:focus-visible` + `[@media(pointer:coarse)]` + 44px hit-target; P1-D "+New" already 44px via `.hit-target`; verified live (11 focusable rows, Tab reveals kebab, Enter switches project). (c) **Chat pop-up identity/context fix** `835518a` (user-flagged from a screenshot of a blank 'System needs your approval' card; audit found the same family across 5 inline cards): new shared guard `client/src/lib/agentDisplay.ts` (`isGenericAgentName`/`resolveAgentName`) generalizes the ReturnBriefing guard — every placeholder ('System'/'Agent'/'Agents'/'A teammate'/'Team'/'Hatch'/'You'/'AI'/''/null) collapses to one honest collective label; applied to approval + completion + handoff + deliverable + deliberation + sidebar-approval cards, briefing refactored onto it. Approval card now self-documents like the sidebar item: shows the task **title** (now sent on the 4 normal `task_requires_approval` broadcasts in taskExecutionPipeline), frames a generic actor as 'A decision is waiting on you', never blank ('Review the details…' fallback). Cost-cap block sent a raw sentence the humanizer (correctly) dropped → now a real code `daily_cost_cap_reached` with a phrase in shared/riskReasons.ts, so the card reads 'Your team hit today's work limit…' instead of blank. DeliberationCard singular/plural fixed. NOT a code bug: the `(authority_default, high_impact_action:delete)` seen in a Maya message is a 22-day-old stored row from before the #43 humanizer fix; the live clarification builder (safety.ts:227) already refuses to interpolate codes. Verified: `scripts/test-chat-card-guards.ts` 28/28 + tsc clean. **Live runtime verification then closed the gap (`ee5c5bf`):** dispatched real `task_requires_approval` frames through the actual client onmessage → schema → handler → card path (via a temporary dev-only socket seam in CenterPanel, since removed) — this surfaced a genuine bug: the `task_requires_approval` WS schema (`shared/dto/wsSchemas.ts`) was a strict `z.object` with no `.passthrough()`, so Zod stripped the server's new `taskTitle` before it reached the card; added `taskTitle: z.string().optional()`. With that, 3/3 live scenarios render correctly: cost-cap 'System' → "A decision is waiting on you" + title + "Your team hit today's work limit…"; real high-risk 'Dev' → name + title + humanized reasons (no raw codes); empty → "Review the details before you decide." (never blank). Path-disjoint from the sibling's Slack/security commits on the branch. Nothing merged. | 2026-08-01 rail refinements (`556f60a`, user-directed): the collapse/expand toggle no longer jumps — Expand moved from the rail bottom to right after search (the same top slot Collapse holds in the expanded Projects header; verified y=95 above folders at y=198, order Account→Search→Expand→New→folders); and the project you're in now renders as a **filled** folder (`fill=currentColor`) in both the rail and the expanded tree, idle folders stay outline (verified live active fill=currentColor / idle fill=none). Nothing merged. | 2026-08-01 (cont.): **hover-to-peek** on the collapsed rail (`a99cfb3`) — hovering the rail expands the full list (120ms hover-intent delay), mouse-leave drops back; grows IN FLOW (an absolute overlay was tried but detaching from flow reflowed the layout under the cursor → enter/leave feedback loop, so in-flow is the stable choice; trade-off is the chat reflows during peek). Verified on an isolated :5006 memory-mode server (8 samples/720ms stable, no oscillation). **Message-drop bug FIXED** (`c76fb4e`, user-reported: own message vanishes while the agent replies, reappears later, clusters around returning-from-away/the briefing): root cause in `client/src/hooks/useChatMessages.ts` merge effect — it rebuilt from the refetch payload keeping only `streaming`/`sending` local messages, but a user message is `sending` only ~ms before it's bumped to `sent`/`delivered`, so the reconnect refetch (fires when the browser comes back online) that resolves before the server persists it DROPS it; fix also retains `sent`/`delivered`/`failed` locals the payload lacks (gated on `!apiIds.has(id)` so the API stays authoritative + WS temp→real reconciliation untouched). Sidebar collapse was coincidental, not causal. Diagnosed by an Explore sub-agent, verified live via a temp queryClient dev seam (since removed): forced the merge with a payload omitting the message → it stayed visible. Nothing merged. | 2026-08-01 **Pre-Launch Hardening pass** (branch feat/v2.2-intelligence-fixes, driven off a pasted 88-finding Master Pre-Launch Audit; the ~88 findings dedupe to far fewer distinct fixes): cross-verified every Tier-0 launch blocker against live code/DB before touching anything, then closed every code-doable one, each self-reviewed and tested BEFORE commit per the new rule "test each fix first, then proceed" (saved 2026-08-01). Shipped 7 fix commits + 3 docs, all server-side, path-disjoint from the parallel v2.1-UX/Slack work: **cc0fb6f** cost brakes (new server/billing/costGuard.ts: per-user rate limit + per-user daily $ cap + global daily $ kill, INDEPENDENT of FEATURE_BILLING_GATES which defaults off, fail-open on DB read error, wired at WS send_message_streaming) + IDOR fix on POST /api/personality/feedback (ownership check + Zod validation) + account-takeover fix (strict getUserByProviderSub, removed the email fallback, explicit OAUTH_EMAIL_CONFLICT throw mapped to /login?error=email_in_use in the OAuth callback, email_verified !== true) + hot-query cap (getMessagesByConversation rewritten to SQL ORDER/LIMIT/cursor with MESSAGES_HARD_MAX 500 + new messages_conversation_created_idx composite index + id tiebreaker); **2cf7d32** DOS-3 cost guard on all LLM-spending HTTP endpoints (generate/iterate/reader-test/packages via enforceCostGuard); **25b41e4** health-check probe + real DB ping (server/routes/health.ts + storage.ping(), returns 503 only on infra/DB down NOT on LLM-provider down; fly.toml check points at /health, NOT /api/health which 401s behind app.use('/api', requireAuth): this catch prevented a deploy that would have 401-killed every instance); **319cf8f** spend alarm (early warning fired once/day in the warn band before the global kill, via maybeFireSpendAlarm + OPS_ALERT_WEBHOOK_URL); **32a17fb** structured error tracker (new server/observability/errorTracker.ts captureException: JSON log + Sentry auto-forward via computed specifier '@sentry/'+'node' so it typechecks WITHOUT the package installed) + generic 500 body in prod (SECRET-2, no stack leak) wired into the Express error handler + uncaughtException + unhandledRejection; **22c7db1** BUG-3 interim (recordEstimatedUsage in usageTracker.ts records a conservative per-generation cost estimate fire-and-forget after handleMultiAgentResponse so multi-agent team turns become visible to both $ caps, integer-cent rounded so free Groq + sub-cent flash turns self-skip; the safety-intervention path was DELIBERATELY not wired because buildClarificationIntervention is a template with no LLM call, so an estimate there would be phantom cost; the exact measured-token version rides ARCH-1). Config knobs (safe defaults): COST_GUARD_MSGS_PER_MIN 40, COST_GUARD_USER_DAILY_CENTS 500, COST_GUARD_GLOBAL_DAILY_CENTS 2000, COST_GUARD_GLOBAL_WARN_CENTS 1400, MESSAGES_HARD_MAX 500, COST_EST_PROMPT_TOKENS_PER_GEN 3500, SENTRY_DSN (optional), OPS_ALERT_WEBHOOK_URL. Verify-first caught 3 real problems before they shipped: the /health 401 deploy-killer, the users.email UNIQUE conflict path (MemStorage test had masked it), and the phantom-cost safety estimate. Tests (local npm is broken, run via ./node_modules/.bin/tsx): test-cost-guard 14/14, test-acct-takeover 6/6, test-messages-query 8/8 live, test-error-tracker 9/9, test-estimated-usage 11/11, verify-estimated-usage-live 2/2 live. **THREE Tier-0 items remain, none code-doable from this environment** (saved to memory project_prelaunch_hardening_remaining so I can remind the user): 0.5 enable Supabase PITR (~2-min dashboard toggle, needs Supabase Pro ~$25/mo ~₹2,150, DO THIS FIRST, the last data-loss gap); 0.4 migration-safety baseline (live schema was built with drizzle-kit push and migrations/ covers only 7 of 21 tables, so a rename/removal in schema.ts can silently DROP COLUMN; full staging-first backup-gated runbook committed 2662002 at .audit-agent-intelligence/MIGRATION-BASELINE-RUNBOOK.md, needs a staging DB + clean npm); 0.6 Sentry install (npm i @sentry/node + set SENTRY_DSN, errorTracker auto-forwards the moment package+DSN exist, needs working npm). Status docs: f427078 .audit-agent-intelligence/TIER0-REMAINING.md, 5aa99ce V2.2-FIXES-AUDIT.md. Recommended next action for the user: the PITR toggle (biggest risk reduction, least effort). Constellation: this footer + HANDOFF.md updated per the user's explicit ask ("update the claude md file and hand off file"); STATE.md + ROADMAP.md + package.json intentionally NOT staged (they carry the sibling session's uncommitted v2.1-UX + Slack work per feedback_parallel_work_safety). Nothing merged; every Tier-0 fix scoped to my own files on the shared branch. | 2026-08-03 Per-role RAG deep knowledge shipped to production-readiness (knowledge workstream, on branch, nothing merged): all 31 roles now hold a deep authoritative corpus (an external Claude Code run gathered 390 sources via server/knowledge/rag/seed/GATHERING-HANDOFF.md into 13 batch-*-deep.json; I cross-verified against live code + DB before trusting it). Ollama embeds are LOCAL ONLY (a deployed server cannot reach 127.0.0.1:11434) so RAG would silently go empty in prod; the user funded an OpenAI key and I re-embedded ALL 31 roles under OpenAI text-embedding-3-small @768d into ONE vector space in Supabase role_knowledge. Final: 3875 chunks, coverage 31/31 (test-rag-coverage 36/36 after fixing a hardcoded-30 fixture to derive roles from ROLE_DEFINITIONS), matrix test-rag-crossrole 5/5. Juhi = Finance Analyst is the 31st registered role (roleRegistry + roleIntelligence, category finance, 103 chunks; ragRoleKey resolves to finance-analyst). Recalibrated RAG_MIN_SCORE 0.55 to 0.40 for OpenAI's lower cosine scale (relevant ~0.45 to 0.63, noise ~0), restoring cross-role diversity (an onboarding query had collapsed 6 sources to 1). UX course re-ingested under OpenAI: all 35 files, 2382 chunks, UX Designer now 2447 (local Ollama had managed only 2 before an HTTP 500). Pluggable embedder in server/knowledge/rag/embeddings.ts (RAG_EMBED_PROVIDER openai|ollama|gemini, one-vector-space rule). .env (gitignored): RAG_EMBED_PROVIDER=openai + RAG_MIN_SCORE=0.40 + OPENAI_API_KEY (USER TO ROTATE, it was pasted in chat). Cost a few cents one-time (about ₹1 to ₹2). Live-proven per verify-in-runtime: my own isolated :5017 memory-mode server (sibling :5001 untouched), Alex (PM) answered a SaaS onboarding question using RICE + aha-moment/activation + Casey Winters Key Action Framework (Product Manager + Growth Marketer cross-role) in a real chat; screenshot captured; :5017 left running. Known gap (UI-approval-gated, NOT built): SourceChips.tsx parses the reply text for a URL, so no chip rendered when the model named frameworks without echoing a URL; the fix is to render chips from the RETRIEVED sources (we know exactly what was injected). Not merged; RAG not yet wired into the prod deploy (now OpenAI so it is production-capable); STATE/ROADMAP/REQUIREMENTS/COMPLETE-GUIDE entries deferred (RAG is a real feature and warrants them, but STATE/ROADMAP/package.json carry a sibling session's uncommitted work per feedback_parallel_work_safety, do not stage). | 2026-08-03 (cont.) Added 3 roles after deciding to SKIP the C-suite (the user is the CEO; CEO/CTO/COO/CMO/CPO/CFO mostly overlap existing roles like Maya/Operations/Marketing/Product/Juhi or undermine the founder, and overlapping roles dilute routing): Legal Counsel (Ira), Sales Lead (Dana), Customer Success Manager (Tess), each a full roleRegistry + roleIntelligence entry with a distinct voice and reasoning profile. Gates green: voice 8/8, pushback 50/50, reasoning 272/272, tsc clean (now 34 roles). Three parallel research subagents gathered 55 faithful real-URL sources (Legal 18: GDPR, CCPA, YC SAFE, USPTO, copyright.gov, IRS, FTC eCFR via Cornell LII, Common Paper, Holloway; Sales 18: MEDDIC, Gong data, Challenger, JOLT, Winning by Design; CS 19: Gainsight, Lincoln Murphy, Kellblog, Bessemer, SaaStr, First Round). Embedded under OpenAI via scripts/ingest-role-knowledge.ts per file (replaceRoles touches only that role, so the 2447-chunk UX course was preserved). New chunks Legal 90 + Sales 60 + CS 82; total now 4107 chunks, coverage 34/34, matrix probe 3/3 (a churn question fuses customer-success + finance; a legal question pairs legal + UX privacy ethics; a sales question pairs sales + marketing). New seed files batch-legal-deep.json / batch-sales-deep.json / batch-cs-deep.json. Competence benchmark earlier this session: matrix OFF 4.40/5 to ON 5.00/5 (+14%, prior cross-role regression fixed). Also decided (user product call): do NOT make citations always visible (it crowds replies and fights the colleague tone); knowledge shows as natural framework-naming, add a subtle on-demand Sources link only if real users ask. | 2026-08-06 Chat Attachments ("Upload & Ask") — ENGINE shipped server-side, on branch, nothing merged, additive + fail-safe. A user can attach a file to a chat and get an answer grounded in it, RAG-backed (not the truncation-dump the brain path still does). New raw-SQL tables `conversation_documents` + `conversation_doc_chunks` mirror `role_knowledge` and live OUTSIDE Drizzle, so a `db:push` can't touch them — this sidesteps the Tier-0 migration-safety gate the brief named as the blocker (created by `scripts/setup-conversation-docs-tables.ts`, 6/6). `server/knowledge/rag/conversationDocs.ts` reuses the role-knowledge machinery unchanged (chunkStructured → embedDocument → pgvector cosine), gated (no attachments = zero added latency), injection-safe cite-or-admit, ephemeral (conversation-scoped) vs brain (project-wide) scopes, short-upload fallback, OWASP-LLM01 injection-drop on ingest. `server/lib/uploadSecurity.ts` magic-byte sniff (renamed binary can't pass the extension filter, INJ-2). `server/routes/attachments.ts` POST/GET/DELETE `/api/conversations/:conversationId/attachments` — hardened multer (10MB), project-ownership, `enforceCostGuard`, per-user daily cap; registered in routes.ts. Retrieval injected into BOTH openaiService prompt paths next to the role-knowledge matrix. Verified live on my own :5018 server (sibling :5001 untouched, killed after): module test 19/19, HTTP test 10/10 (caught + fixed a real short-doc→zero-chunks bug), real-LLM A/B 2/2 (Alex grounds "11 minutes, per the Aurelian Ledger Spec file" WITH the file, refuses to invent it WITHOUT), tsc clean. Config: RAG_DOC_TOP_K, RAG_DOC_MIN_SCORE (→RAG_MIN_SCORE 0.40), RAG_DOC_DAILY_CAP=50, RAG_DOCS_ENABLED kill-switch. **Composer UI SHIPPED 2026-08-07 (`c585ec6`), one-tap model:** paperclip + file chip in `ChatInput.tsx`, new `useAttachments.ts` hook + `AttachmentChip.tsx`; server `promoteToBrain()` + PATCH route for the optional "Add to project brain". The forced two-choice menu was rejected by the user as confusing (2026-08-06) — attach stays in the chat, brain-promotion is optional. Retention: files persist + stay agent-searchable forever until deleted with the × (nothing auto-expires; "ephemeral" = conversation-scoped not time-limited). **Proven live end-to-end** on isolated :5018 (real providers): upload→201→Ready chip→asked "Nimbus free trial?"→Maya grounded "exactly 23 days" naming the file→remove, Playwright 1/1 + screenshot, tsc clean. The 1-line `conversationId` prop in CenterPanel.tsx got swept into parallel commit `af4be6b`. Phase 4 (harden brain-commands) + Phase 5 (images/CSV/URL) remain. Brief: `.planning/milestones/chat-attachments-BRIEF.md`. STATE/ROADMAP/REQUIREMENTS/GUIDE deferred (sibling-dirty per feedback_parallel_work_safety). | 2026-08-10 Business-in-a-Box packs milestone kicked off (new scoped milestone `.planning/milestones/business-in-a-box/`; turns each starter pack from "3 generic agents + a welcome line" into a guided operating system: right team + prefilled direction + staged tasks + pre-scaffolded documents). Decisions (user): D-1 = BOTH SaaS Startup + Restaurant Launch flagships (digital + local/physical); D-2 = deep packs for EVERYONE now, Pro gate later. **BIAB-0 increment 1 shipped server-side, on branch, nothing merged, additive + fail-safe:** new `shared/packBlueprints.ts` (PackBlueprint data model + two deep flagship blueprints: SaaS 7 agents/15 tasks/9 docs, Restaurant 6/15/8; real roleRegistry roles → correct character names; **Finance/Juhi + Legal/Ira now appear in packs, were in ZERO before**; no invented stats, blueprints are structural, sourced playbook is a later BIAB-1 layer) + new `server/starterPacks/seedBlueprint.ts` (`seedPackBlueprint` works through the IStorage interface so MemStorage + DatabaseStorage share ONE code path; idempotent; docs seed as cheap zero-LLM scaffolds per OPS-01; wires the bidirectional task↔deliverable link PROC-06). Both `initializeStarterPackProject` paths delegate to it when a pack has a blueprint, else legacy team-only seeding; the project-creation route already calls it so no route change. Type-only schema edits (no migration, `69d4e54` pattern): `deliverables.type` += business-plan|financial-model|legal-checklist|brand-guide|sop, `tasks.metadata` += stage|order|fromBlueprint|producesDocType, `deliverables.metadata` += stage|fromBlueprint|isScaffold; new type specs in `shared/deliverableTypes.ts`. Verified: `scripts/test-pack-blueprint-seed.ts` 44/44 (both flagships: direction/team/briefs/staged-tasks/scaffolds/bidirectional-link/idempotency + legacy pack still team-only) + full HTTP path on my own memory-mode :5020 (sibling :5001 + my prior :5019 untouched, :5020 killed after): dev-login → POST /api/projects{starterPackId:saas-startup} → 7 named agents incl. Juhi+Ira, 15 tasks {prereq4/build4/launch4/grow3} 9 linked, 9 doc scaffolds back-linked; tsc clean. **Next is mockup-first (ZERO UI code until approved):** Restaurant pack CARD in the picker (new Local & Services category; blueprint data ready), deeper pack-picker preview (UX-01/02), task→document "View document" link (UX-03). Constellation: milestone's own REQUIREMENTS/ROADMAP/README + this footer + HANDOFF updated; top-level STATE/ROADMAP/REQUIREMENTS + COMPLETE-GUIDE intentionally NOT touched (sibling-dirty per feedback_parallel_work_safety; BIAB is scoped/additive). **BIAB-1 UX slice — in-project Journey view — shipped 2026-08-10** (the visible payoff of increment 1): mockup-first gate followed (clickable prototype `artifact/555930c6` with a Today-vs-Journey toggle, user approved + locked 3 decisions: core + live working-state, reuse the existing Artifact panel, soft guidance never gates), then built `client/src/components/sidebar/JourneyView.tsx` (NEW) wired into `TasksTab.tsx` (staged `metadata.stage` project → Journey, else legacy board). Staged path Get set up→Build→Launch→Grow with progress + plain-word pills, "Your first 3 moves" + Pro/autonomy-gated delegate CTA (reuses `delegate_todos`), role-colored avatars incl. new Juhi/Ira, live "Working on it now" (`useAgentWorkingState` + task `in_progress`), and each producing task's doc chip opens the REAL Artifact panel via the existing `open_deliverable` event. **Zero sibling-owned files touched** (all side-effects via existing window events, no home.tsx/CenterPanel edits). Verified live on own :5021 memory server via independent headless Playwright (own browser, sibling :5001 + prior :5019 untouched, :5021 killed after): Journey renders, doc chip opens "SaaS Business Plan" scaffold, screenshots captured; tsc clean. Fast-follow (still mockup-first): editable presets (skip/add/reassign/delete) + per-stage playbook hook; Restaurant pack card + picker depth; routing into the Tasks tab post-creation needs sibling coordination (home.tsx). **Front-door strategy converged 2026-08-10** (~6 iterated clickable mockups; user pressed "is this the best?"): new-project entry = **two separate doors** — "Start with your idea" (FREE, Maya assembles a team for ANY idea, never dead-ends) and "Start from a pack" (packs shown prominently as **Pro**). Packs are **freemium** (some free+usable, deep ones Pro: preview free → upgrade to launch). **Moat decision** (user's key point "what stops them just adding the team?"): the value is NOT the roster, it is the **cited field playbook + documents-built-to-spec + verified orchestration** the Pro packs carry; preview teases depth, gates mastery. Updates the earlier "packs free for everyone" lean → **packs = freemium, Pro = the deep playbook layer.** **Server foundation shipped same day (server-only, no UI gate, on-branch, my files):** `shared/packBlueprints.ts` += `tier:'free'|'pro'` (SaaS free / Restaurant Pro, a one-field decision) + `packCatalog()`/`getPackTier()`; new `server/starterPacks/packRouter.ts` (`classifyIdea` w/ `// LLM-SEAM`, `routeIdea`→pack|assemble|clarify, `assembleBlueprint(idea)` = generative fallback → a real seedable blueprint); `storage.initializeAssembledProject()` (both impls) seeds an assembled idea via the SAME seedPackBlueprint; new `server/routes/packs.ts` (`GET /api/packs/catalog` + `POST /api/packs/route`, registered). Verified `scripts/test-pack-router.ts` 27/27 + live HTTP on own :5022 (killed after; sibling :5001 untouched); tsc clean. **Moat plumbing shipped same day (server-only, my files):** pack agents get the pack's FIELD PLAYBOOK injected at chat time. `shared/packBlueprints.ts` += `playbook:{field,primer,frameworks[]}` on both flagships (real framework NAMES only, no baked-in stats — specifics grounded in RAG per cite-or-admit); `projects.executionRules.packId` (type-only) stamps the pack, seeder writes it; new `server/starterPacks/packPlaybook.ts` (`getProjectPackId`, `renderPackPlaybookBlock` gated to '' for assembled/unknown/non-pack, `boostQueryForPack`); wired into BOTH openaiService paths next to the role-knowledge matrix. Verified `scripts/test-pack-playbook.ts` 20/20 + deterministic runtime capture (SaaS project → 964-char playbook injected; plain → 0/gated) + **live Gemini vibe-check** (`test-pack-playbook-live.ts`): SaaS-pack PM reached for RICE, plain PM gave generic MoSCoW — moat proven (Groq was 429 free-cap → mock via the fail-safe chain, used Gemini for the real reply); tsc clean. Next: content-ops to cite the flagship playbooks (deepen Pro value), then UI mockup-first. | 2026-08-13 Approval-card redesign + daily-limit one-notice fix (on-branch, nothing merged, path-disjoint from the sibling's active landing/packs/storage edits). Root-cause bug (user-flagged from a screenshot of the same "A decision is waiting on you" card stacked 5×): the daily cost cap fired a per-task `task_requires_approval` card for EVERY blocked task, each with a DEAD Approve button (the task is `status:'blocked'`+`costCapReached`, never `awaitingApproval`, so `resolveTaskApproval('approve')` 400s). Server `taskExecutionPipeline.ts`: the cap now emits ONE project-level `autonomy_daily_limit_reached` notice (client collapses N→1, no fake buttons); the 4 real approval fire-sites additionally send `taskDescription`+`riskScore`+`draftPreview` (new `approvalDraftPreview()` helper). `shared/dto/wsSchemas.ts`: extended the `task_requires_approval` object (default-strip would drop the new keys) + added the `autonomy_daily_limit_reached` union member (the `z.union` drops unknown `type`s). Client: mockup-first gate honored (2 clickable artifacts, ~7 iterations as the user pivoted the design — drop the yellow left rail per `feedback_no_left_accent_rail`, ONE shared box not two, Claude-simple but keep FULL decision detail, then add COLOR=stakes because the Activity sidebar is component-dense). New shared `client/src/components/approval/ApprovalCard.tsx` used by BOTH chat (`AutonomousApprovalCard` now a thin adapter) and sidebar (`ApprovalItem` rewritten): no left rail, accent border+icon+label tinted red for destructive / blue for normal via new `isDestructiveRisk()` in `shared/riskReasons.ts`, full description + humanized "Why this is paused" panel + "See what X prepared" expand, risk-aware buttons (destructive → safe "Not now" leads + cautious red-outline confirm; normal → blue primary leads). New `client/src/components/approval/DailyLimitNotice.tsx` (neutral, dismissible, "Got it" only) rendered in `ChatMessageList`; `CenterPanel` stores the enriched fields + a single `dailyLimitProjectId` (collapses repeats, clears on project switch); `sidebar/ActivityTab.tsx` amber "Needs your approval" heading neutralized; new `client/src/lib/relativeTime.ts`. Verified: tsc 0 errors; test-risk-reason-humanizer 8/8; test-chat-card-guards 28/28; `isDestructiveRisk` 6/6; WS schema round-trips both new frames preserving all fields; LIVE real-browser render on own :5077 memory server (sibling :5001 untouched, killed after) — all 4 cards rendered with correct red/blue data-risk classification, humanized reasons (no raw codes), risk-aware button order, neutral notice, 0 page errors, via a temp dev-only `?approvalPreview=1` seam in CenterPanel since fully reverted. NOTE the SERVER half needs a full :5001 restart to take effect (dev is plain `tsx`, no watch); the client half hot-reloads via Vite. STATE/ROADMAP/REQUIREMENTS/COMPLETE-GUIDE intentionally not touched (a UX + bug-fix pass on the existing approvals feature ships no new requirement, per the 2026-07-23 + Phase 4 precedent; also sibling-active per feedback_parallel_work_safety). | 2026-08-14 Business-in-a-Box Batch 2 packs shipped on-branch (built on the clean base after the user committed the 3-session snapshot f521ebf): 4 new deep PackBlueprints, Web3 (web3-startup 🔗), AgTech (agtech-startup 🌾), Logistics (logistics-startup 🚚), Telehealth (telehealth-startup 💻), authored from 4 researched, sourced specs (real named frameworks, cited, no invented numbers) with guardrails baked into direction/roleBriefs/docs/tasks/playbook: Web3 token-is-utility-never-investment + security-first + securities/tax jurisdiction-dependent-verify-counsel; AgTech proof-first-no-guaranteed-yield + food-safety-verify-authority; Logistics DOT/FMCSA verify-locally; Telehealth BUSINESS-OF-CLINIC-ONLY (clinical scope/licensure owned by the founder's medical director + clinicians, HIPAA/billing verify-with-counsel-not-legal-or-medical-advice). Telehealth is deliberately DISTINCT from the existing physical healthcare-clinic pack and uses 💻 not 🩺 to avoid a duplicate tile. Kept in a NEW shared/packBlueprintsBatch2.ts (type-only import of PackBlueprint/BlueprintStage so no runtime circular dep; exports BATCH2_PACKS) so the sibling's 3,727-line packBlueprints.ts took only a 2-line edit (import + Object.fromEntries(BATCH2_PACKS...) spread into PACK_BLUEPRINTS), minimal collision surface. Verified: tsc 0 errors; packCatalog 40 to 44; a validation script confirmed every producesDocKey links to a real doc and every doc/task role is on-team; the real seeder via MemStorage created agents + staged-tasks + doc-scaffolds + bidirectional-links for all 4 (web3 9a/16t/12d/12l, agtech 8/16/12/12, logistics 8/16/12/12, telehealth 8/15/12/12). Playbooks carry the real authoritative framework NAMES (OWASP SC Top 10, ERC/SCOR, HIPAA rules, 4Rs) with plain-language glosses; specifics stay ungrounded per cite-or-admit (RAG grounds at answer time). NOT done: the client category-map in StarterPacksModal does not know the 4 new packIds yet (they may land in a default picker bucket, small UI edit pending mockup-first); live browser picker check. Specs in scratchpad pack-spec-*.md. Also this session: RAG deepening campaign started (DEEPENING-CAMPAIGN.md + GATHERING-HANDOFF.md extended to all 34 roles + a new-agent SOP) to make every role's knowledge base even/top-1% (mastery-map coverage, >=20 sources, >=60% A-tier, anti-patterns); Batch 1 (Content Writer/Operations Manager/DevOps/QA Lead) gathered partially then paused on a platform-wide connection outage, fully resumable from agent transcripts + incremental seed files (all A-tier). Nothing merged. | 2026-08-15 RAG deepening campaign COMPLETE, all 34 roles even + mastery-complete. Ran 8 batches of deep-gather subagents (each role: a mastery map of 16 to 32 authoritative primary sources with faithful heading-structured extracts + anti-patterns, additively ingested via scripts/ingest-add-seed.ts with OpenAI embeddings, existing chunks preserved). Result verified live via rag-corpus-health.ts: 33 roles moved from a scattered 35 to 103 chunks into a tight even band of 130 to 209 chunks (UX Designer stays 2447, course-fed); corpus 4429 to 7852 chunks; report says all roles above threshold, none thin. Committed per batch: 4f770ab, 7a24d17, fda4673, daad8b7, 9c51e7e, ca11b36, fbb6235, 519afbf. Two platform interruptions (connection outage + two account session-limit hits) were absorbed by the every-2-sources incremental-save design (zero rework) and resumed cleanly. Notable: Creative Director A-tier rose 8% to 39% (new content 65% A). Optional consolidated top-up remaining (REPLACE old low-tier chunks, not additive) to lift 6 roles past 60% A-tier: Copywriter 52, Marketing 49, Creative Director 39, Brand Strategist 49, Business Analyst 57, Instructional Designer 57 (all already mastery-covered; dip is from pre-existing lower-tier chunks blending in). Process doc GATHERING-HANDOFF.md extended to all 34 roles + a new-agent SOP, so any future agent gets the identical treatment. Tracker: server/knowledge/rag/seed/DEEPENING-CAMPAIGN.md. Nothing merged. | 2026-08-15 v2.3 agent-intelligence investigation (branch feat/v2.2-intelligence-fixes, nothing merged, all on-branch, answers "are the agents top-1% and how do we get there WITHOUT depending on/paying for a premium LLM"): Built a proper 6-dimension competency benchmark (knowledge/diagnosis/application/judgment/creativity/rigor; blind cross-model Groq judge; RAG on/off + model A/B; scripts/eval-all-roles-competence.ts + eval-competence-dimensions.ts, committed earlier this session as 561900e + 75f6b45; the earlier top-1% prompt scaffold TOP1_SCAFFOLD was 1ef5672). FINDINGS: (1) knowledge base + cross-role MATRIX are already maxed and LIVE (RAG_ENABLED + TOP1_SCAFFOLD both default 'on' in code; cross-role retrieval verified pulling e.g. Marketing+UX+Finance chunks for a pricing question), so knowledge was never the gap; (2) the top-1% gap is REASONING-side (creativity floor ~2.7 to 2.9), not knowledge; (3) prompting alone is marginal; (4) DeepSeek V4-Pro is NOT an unlock (reasoning flat-to-worse vs Flash, commit f086cb3); (5) a true frontier model PROVES the ceiling is model-bound: gpt-5 with everything else held constant lifts reasoning +0.48, creativity 2.73 to 3.40, top-1%-on-all-6 3 to 11/30 (commit 1e89971, which also carries a REAL latent bugfix: server/llm/providers/openaiProvider.ts now drives reasoning models via max_completion_tokens + fixed temperature, additive + guarded + dormant unless LLM_PRIMARY=openai). USER DECISION (explicit): stay on DeepSeek, do NOT pay for GPT; own knowledge + matrix + method as the base, the LLM is a cheap swappable ENHANCEMENT layer, not a dependency. THE DEEPSEEK-ONLY FIX SHIPPED (commit 883c7fd, gated OFF): server/ai/multiPass.ts, a role-selective, rigor-gated cheap multi-pass, DeepSeek drafts then a FREE Groq critic scores the draft against an OWNED-METHOD rubric (diagnosis/application/judgment/rigor + creativity only where the role warrants it) then DeepSeek revises. HARD GUARANTEES per user: no rigor dip (a revise is accepted ONLY if a free critic scores its rigor >= the draft's, else keep the draft) and creativity is a target ONLY for non-precision roles (finance/legal/data/QA/engineering/operations skip it, since the A/B showed multi-pass net-HURTS them). Wired into the non-streaming generateIntelligentResponse path (Slack + /api/hatch/chat + benchmark). 34-role A/B, shipped selective config vs the single-pass floor: overall 3.49 to 3.66, EVERY dimension flat-or-up, rigor +0.26, per-role rigor dips 11 to 5/34 (residual = judge noise). Config: MULTIPASS_ENABLED (default off) / MULTIPASS_CRITIC_PROVIDER (groq) / MULTIPASS_MIN_CHARS (220) / MULTIPASS_RIGOR_GATE (on) / MULTIPASS_ALL_ROLES (off). DELIVERABLES tested + NOT shipped (commit 8e22061): a document-mode A/B on 6 creative-role deliverables proved multi-pass no-ops on long structured docs (single-pass drafts already ~4.7/5, 0/6 fired, 0 truncation), so the deliverable wiring was written, tested, then REVERTED; autonomy tasks already have their own critique-revise loop (v2.2 peer-review regeneration). NET: multi-pass is a proven, banked, gated-OFF capability whose real value is SHORT chat answers; its ideal home (interactive streaming chat) was declined for the streaming-latency cost, so it stays OFF pending a decision. Ollama (user installed llama3.2:3b) is too small to be the critic and unreachable from a deployed server, so the prod critic is free Groq 70B; Ollama stays a local-only option. Constellation: CLAUDE.md footer + HANDOFF updated; STATE/ROADMAP/REQUIREMENTS/COMPLETE-GUIDE intentionally NOT touched (research + a gated-off capability ship no new user-facing requirement, and STATE/ROADMAP carry a sibling session's uncommitted work per feedback_parallel_work_safety). | 2026-08-24 to 08-26 learning-loop investigation + live multi-pass proof (branch feat/v2.2-intelligence-fixes, all on-branch, nothing merged): (1) LEARNING LOOP MEASURED — verified Hatchin's self-improving loop is built + wired (AKL canon-promotion, growth-loop lessons LEARN-01 in qualityLessons.ts, skillLearner, personalityEvolution, trust) but it does NOT make agents smarter turn-to-turn: `scripts/eval-learning-loop.ts` (real path, peer-review lesson → seeded peer_review_feedback event → getQualityLessons injection, model held constant, 2 samples/arm) = growth-loop lessons OFF→ON +0.08/dim, INSIDE the noise (per-role Δ stdev 3.42 vs mean 0.50), and hurts precision roles; the AKL (the STRONG mechanism) is DORMANT — root cause: `shouldAllowWebCalls()`=`ENABLE_WEB_IN_PROD_MODE` default false + no search key → runRoleScopedResearch returns blocked → akl/runner.ts:98 early-returns promoted:false, so it detects+logs gaps but never learns (likely deliberate cost/injection-safety gate). Confirms the audit's "remembers but doesn't get smarter" with numbers. Corrected an old worry: RAG is confirmed LIVE (RAG_ENABLED default on; cross-role matrix verified pulling Marketing+UX+Finance for a pricing question). Committed bb90407. (2) OUTCOME-BASED GROWING-PLAYBOOK PLAN written, NOT built — `.planning/growth-loop-outcome-based-PLAN.md` (commits 6091148 + 608b6f7): a growing playbook that learns from Hatchin's OWN successful work (needs NO web, unlike the dormant AKL), 3 gates (real outcome signal / repetition / gatekeeper+rollback — the last already EXISTS as AKL governance/promotion), grounded in behavioral outcome signals already in code (deliverable kept-vs-reverted+editsCount+resolved-annotations; task done-vs-reopened; Keep/Refine card; thumbs), reuses the RAG matrix, space a non-issue (tiny lessons+dedupe+retrieve-only-relevant). SEQUENCED: Phase 1 = capture the outcome signal as a read-only SCOREBOARD (does the product help users? the "zero live quality metrics" gap) — cheap, pre-launch-safe; Phase 2 = the learning layer, DEFERRED until the scoreboard shows patterns + there is user volume. Honest ceiling: frozen model = better notes, not a smarter brain. (3) LIVE MULTI-PASS PROOF (2026-08-26): ran the role-selective multi-pass (883c7fd) live on an isolated :5099 server (real DeepSeek writer + free Groq critic), on the REAL /api/hatch/chat endpoint, before/after blind-judged — best-case (3 short chat Qs on creative roles) overall 3.61→4.67 (+1.06, every dim up); the realistic 34-role average stays +0.17. COVERAGE confirmed: multi-pass applies to ALL non-precision roles automatically via `creativityMattersFor(role)` (reads getRoleIntelligence(role).category; PRECISION_CATEGORIES finance/legal/data/quality/engineering/operations SKIP), and auto-extends to any NEW agent by its category with zero code (caveat: a brand-new category defaults to GETTING it — add it to the precision set if it should skip). Still gated OFF (MULTIPASS_ENABLED), non-streaming path only, nothing merged. `scripts/demo-multipass-live.ts` + artifact claude.ai/code/artifact/cb991b0b-8f30-40e9-ab2a-df5fe77575f8. (4) BACKUP (2026-08-25): tag `backup/full-snapshot-2026-08-25` at HEAD + pushed branch+tag to the dedicated `backup` remote (hatchin-private-backup) + local `~/hatchin-backups/2026-08-25/` (verified 85M all-refs bundle + 317M full-worktree tar incl. uncommitted + .env). NOTE: this branch also carries concurrent SIBLING commits this window (external-repo borrow-catalog backlog docs, entry-bundle perf, sign-in/404/hero-v5 landing redesign, DESIGN.md brand-spec injection, no-dash hardening, bull/bear debate engine) — those are a parallel workstream, not detailed here. | 2026-08-26 to 08-28 IN-CHAT DOCUMENT EDITING shipped on-branch (nothing merged), a real user-facing feature = "upload a document in chat, tell an agent to edit it, get it back in the SAME format", exactly the ChatGPT/Claude behavior the user asked for. Three commits: (1) 5ebc25d ENGINE — `server/documents/documentEditor.ts` (extract → real DeepSeek edit → write back to the same format), `markdownToDocx.ts` (via the installed `docx` package), `markdownToPdf.ts` (playwright headless-Chromium HTML→PDF, a much better renderer than the old pdfkit; PDF uses the regenerate-a-fresh-PDF approach, the same thing the big tools do); edit step is conservative (preserve + add relevantly, never invent facts/citations); proven `scripts/test-document-editor.ts` 8/8 + a real GreenLeaf brief screenshot (`demo-doc-edit-visual.ts`). (2) 071e972 BACKEND — `conversation_documents.raw_bytes` keeps the ORIGINAL file (attachments previously kept only RAG chunks) + `conversation_edited_documents` keeps outputs (additive raw SQL, `scripts/setup-document-edit-tables.ts`); `POST /api/conversations/:cid/attachments/:docId/edit` posts BOTH the user's request AND an agent reply carrying `metadata.editedDocument{downloadUrl,...}` into the chat + broadcasts them; `GET .../attachments/edited/:editedId/download` streams the file (ownership + conversation scoped); the editor returns a deterministic added/kept-sections summary for an honest reply; proven `scripts/test-doc-edit-backend.ts` 9/9 on real Supabase + DeepSeek. (3) 3c4114f UI — `EditedDocumentCard.tsx` (the ONE new element: file + "same format you sent" + Download link), rendered in `MessageBubble` when a message has `metadata.editedDocument`, `ChatMessageList` passes that metadata through (it was being dropped in the bubble remap — the one bug found live), `useAttachments.editDocument()` + `looksLikeEditRequest()` intent helper, `ChatInput` routes a ready editable attachment + an edit-style message to the editor instead of a normal chat turn. Formats: Word/.docx, PDF, Markdown, text, **and now Excel/.xlsx + CSV** all round-trip (Excel/CSV shipped 2026-09-02, commit `6e5c7a8`: `server/documents/spreadsheet.ts` bridges each sheet through a markdown table the agent edits, written back via the `exceljs` 4.4.0 package; v1 = tabular data, formulas/charts not preserved; proven `scripts/test-spreadsheet-editor.ts` 9/9, the agent even computed a Total column correctly). All six formats edit in chat. Edit-vs-question routing is a conservative keyword heuristic (edit verbs + a ready attachment; a real question about the file still just gets answered). PROVEN LIVE end-to-end on an isolated :5090 server (real browser + real DeepSeek, memory mode, sibling :5001 untouched): created a project, attached Launch-Plan.md, asked "add Risks + Success Metrics", Maya's reply rendered the download card and the download returned HTTP 200 with the sections added + the original kept (screenshot `scratchpad/doc-edit-in-chat-proof.png`). Mockup-first honored (2 clickable artifacts; the first was a wrongly-separate tool screen, corrected per the user to fully in-chat). Backed up to the `backup` remote. NOTE this branch also still carries the parallel sibling workstream. | Author: Claude Code*
