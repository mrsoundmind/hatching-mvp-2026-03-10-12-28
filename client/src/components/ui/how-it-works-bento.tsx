  ...
  return (
    <div className="relative rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 overflow-hidden h-full">
      ...
      <div className="space-y-3">
        ...
        >
          <div className="rounded-2xl rounded-tr-sm bg-orange-500 text-white px-3.5 py-2 text-xs leading-relaxed shadow-sm">
        ...
        >
          ...
          <div className="rounded-2xl rounded-tl-sm bg-white/[0.06] border border-white/10 px-3.5 py-2 text-xs leading-relaxed text-white/80">
        ...
        <motion.div
          ...
          className="flex items-center gap-2 pt-1 text-micro text-white/40"
        >
      ...
      <div className="mt-5 flex items-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-3 py-2">
        ...
        <span className="text-micro text-white/40 flex-1">Reply to Maya...</span>
      ...
      <div className="grid grid-cols-3 gap-3">
        {hatches.map((h, i) => (
          ...
          >
            ...
            <div className="text-micro font-semibold text-white/90">{h.name}</div>
            <div className="text-xs text-white/40 uppercase tracking-wider">{h.role}</div>
          </motion.div>
        ))}
      </div>

      <div className="mt-4 flex items-center justify-between rounded-xl bg-orange-500/10 border border-orange-400/20 px-3 py-2">
        <div className="flex items-center gap-2 text-micro text-orange-300 font-medium">
          <Check className="w-3 h-3" />
          6 teammates ready
        </div>
        <span className="text-xs text-orange-400/70">just now</span>
      </div>
    </div>
  );
}
...
function Card3() {
  ...
  return (
    <div className="relative rounded-3xl border border-white/10 bg-white/[0.03] backdrop-blur-sm p-6 overflow-hidden h-full">
        ...
        {tasks.map((t, i) => (
          ...
          >
            <div className="flex items-center gap-2.5 mb-2">
              ...
              <span className="text-xs font-semibold text-white/60 tabular-nums">{t.pct}%</span>
            </div>
      ...
      <div className="mt-4 flex items-center justify-between text-micro">
