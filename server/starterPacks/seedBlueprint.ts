...
const ROLE_COLOR: Record<string, string> = {
  ...
  "Instructional Designer": "green",
  "Audio Editor": "green",
  "Marketing Specialist": "green",
  "Creative Director": "purple",
  "Designer": "green",
  "UI Designer": "green",
  "UX Designer": "green",
  "UI Engineer": "blue",
...
const TEAM_INFO: Record<string, { name: string; emoji: string }> = {
  ...
  success: { name: "Customer Success", emoji: "🌟" },
};
